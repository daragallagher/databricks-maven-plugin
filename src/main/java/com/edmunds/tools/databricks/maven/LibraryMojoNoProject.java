...
import com.edmunds.tools.databricks.maven.factory.SerializedLibraryClustersModelFactory;
...
public class LibraryMojoNoProject extends LibraryMojo {
    ...
    protected LibraryClustersModel getLibraryClustersModel() throws MojoExecutionException {
        return new SerializedLibraryClustersModelFactory(libraryMappingFile).getLibraryClustersModel();
    }
}
